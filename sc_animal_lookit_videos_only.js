function generateProtocol(child) {
  ...
  const frames = {
    ...
    "video-config": { "kind": "exp-video-config" },
    "video-consent": {
    ...
    "positioning": {
      ...
      "instructionBlocks": [
        { "text": "You and your child can sit in any position.", "title": "Get comfortable" },
        { "text": "Go ahead and get settled and use the webcam preview to make sure your child’s whole face and torso are in view.", "title": "Take a few moments" },
        { "text": "Press the \"Next\" button down below if you and your child are in position and ready to go.", "title": "When you're ready" }
      ],
    ...
    "frameList": [
      {
        ...
        "parentTextBlock": { "text": "Please help your child attend back to the video if they miss anything, and avoid influencing your child's response. As the videos are large, they may take a moment to load." }
      },
      {
        ...
        "audioTypes": ["mp3", "ogg"],
        "images": [
          { "id": "parentinstruction", "src": "parentinstruction_SCAnimal.png", "position": "fill", "nonChoiceOption": true }
        ],
        "parentTextBlock": { "text": "Text will appear below here, inside of a green box, with a prompt for you to say to your child.", "css": { "backgroundColor": "green", "color": "white" } }
      },
      {
        "id": "mousecheck1",
        "kind": "exp-lookit-video",
      ...
      },
      {
        ...
        "autoProceed": true,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "mousecheck_part1_SCAnimal_short", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video if they miss anything, and avoid influencing your child's response. As the videos are large, they may take a moment to load." }
      },
      {
        ...
        "choiceRequired": true,
        "images": [
          { "id": "mousecheckquestion", "src": "mousecheck_finalquestion.png", "position": "fill", "nonChoiceOption": true },
          { "id": "animalgame", "src": "transparent.png", "height": 50, "left": 15, "top": 10 },
          { "id": "artgame", "src": "transparent.png", "height": 50, "left": 61, "top": 10 }
        ]
      },
      {
        "id": "miccheck-video",
        ...
        "parentTextBlock": { "text": "Please help your child speak loudly and clearly when prompted." }
      },
      {
        "id": "animalintro1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "animalintro_part1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video if they miss anything." }
      },
      {
        "id": "animalintro2",
        "kind": "exp-lookit-video",
        "videoTypes": ["webm", "mp4"],
                "choiceRequired": false,
        "video": { "source": "animalintro_part2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video if they miss anything." }
      },
      {
        "id": "animalintro3",
        ...
        "videoTypes": ["webm", "mp4"],
                "choiceRequired": false,
        "video": { "source": "animalintro_part3_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video if they miss anything." }
      },
      {
        "id": "color1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "color2_self_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "food1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "food1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "activity1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "activity1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "results1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "results1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "color2",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "color2_parent_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "food2",
        "kind": "exp-lookit-video",
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "food2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "activity2",
        ...
        "kind": "exp-lookit-video",
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "activity2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "results2",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "results2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please help your child attend back to the video." }
      },
      {
        "id": "choice1",
        "kind": "exp-lookit-video",
                "choiceRequired": false,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "choice_selffirst_part1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please allow your child to watch carefully." }
      },
      {
        "id": "choice2",
        "kind": "exp-lookit-video",
        "autoProceed": true,
        "videoTypes": ["webm", "mp4"],
        "video": { "source": "choice_selffirst_part2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please allow your child to watch carefully." }
      },
      {
        "id": "final-choice-question",
        "kind": "exp-lookit-images-audio",
        "audio": "finalquestion",
        "audioTypes": ["mp3", "ogg"],
        "choiceRequired": true,
        "images": [
          { "id": "finalprompt", "src": "finalquestion.png", "position": "fill", "nonChoiceOption": true },
          { "id": "left-choice", "src": "transparent.png", "height": 34, "left": 19, "top": 65.5 },
          { "id": "right-choice", "src": "transparent.png", "height": 34, "left": 59, "top": 65.5 }
        ]
      }
    ]
  };
  ...
  const trials_other = {
    ...
    "frameList": [
      ...
      },
      {
        ...
        "videoTypes": ["webm", "mp4"],
                "choiceRequired": false,
        "video": { "source": "choice_parentfirst_part1_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please allow your child to watch carefully." }
      },
      {
        "id": "choice2",
        ...
        "videoTypes": ["webm", "mp4"],
        "choiceRequired": false,
        "video": { "source": "choice_parentfirst_part2_SCAnimal", "width": 100 },
        "parentTextBlock": { "text": "Please allow your child to watch carefully." }
      },
      {
        "id": "final-choice-question",
